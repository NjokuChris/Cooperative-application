    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-default">
                ...
                <form method="post" action="{{ route('approval_flow.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="process_module_id">
                                        <option value="">Select Process Module</option>
                                        @foreach ($process_module as $p)
                                            <option value="{{$p->id}}">{{$p->process_module}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="approval_stage_id">
                                        ...
                                        @foreach ($approval_stage as $p)
                                            <option value="{{$p->id}}">{{$p->approval_stage}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
