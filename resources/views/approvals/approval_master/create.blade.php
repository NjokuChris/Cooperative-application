                ...
                <form method="post" action="{{ route('approval_stages.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="bmd-label-floating">Approve Description</label>
                                    <input type="text" class="form-control" name="approve_desc">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="bmd-label-floating">Approval Type</label>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="bmd-label-floating">Approval Approval Stage</label>
                                    <select class="form-control select2" name="process_type_id">
