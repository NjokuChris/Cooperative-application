...
@section('content')
    ...
    <section class="content">
      <div class="container-fluid">
        <p>
            <a href="{{route('roles.create')}}" class="btn btn-primary">Create New Roles</a>
        </p>
        <div class="row">
          <div class="col-12">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/admin/roles/{{ $r['id']}}"><i class="fa fa-eye"></i></a>
                            <a href="/admin/roles/{{ $r['id']}}/edit"><i class="fa fa-edit"></i></a>
                            <a href="#" data-toggle="modal" data-target="#deleteModal1" data-roleid="{{$r['id']}}"><i class="fa fa-user-times"></i></a>
                        </td>
