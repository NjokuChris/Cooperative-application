    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-default">
                ...
                <div id="error"></div>
                <form method="post" action="{{ route('withdrawers.store') }}" id="bid_form_id" name="withdrawers" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="current_balance" required readonly class="form-control" id="current_balance_id" value="">
                                </div>
                            </div>
