...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Search Cash Withdrawer Report.</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Cooperative Cash Withdrawer Report Search Form</h3>
                </div>
                <form method="post" action="{{ route('withdrawer_report')}}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div>
                                <div class="col-md-4">
                                    <div class="">
                                        <label class="">Withdrawer ID</label>
                                        <input type="text" name="withdrawer_id">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="bmd-label-floating">Withdrawer Amount (Greater Than)</label>
