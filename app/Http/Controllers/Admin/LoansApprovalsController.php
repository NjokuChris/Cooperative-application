...
class LoansApprovalsController extends Controller
{
    ...
    public function index()
    {
        ...
        $arr['loans'] = loans::where('first_approver', $user_id)->where('approval_stage_id', $approval_stage_id)->orderBy('id', 'desc')->get();
        $arr['loans1'] = loans::where('approval_stage_id', $approval_stage_id)->orderBy('id', 'desc')->get();
        //dd($arr);
